...
#[derive(Parser, Clone, DebugAsJson, serde::Serialize)]
pub struct RpcServerConfig {
    /// JSON-RPC server binding address.
    #[arg(id = "rpc.address", short = 'a', long = "address", default_value = "0.0.0.0:3000")]
    #[serde(rename = "address")]
    pub rpc_address: SocketAddr,

    /// JSON-RPC server max active connections
    #[arg(id = "rpc.max_connections", long = "max-connections", default_value = "400")]
    #[serde(rename = "max_connections")]
    pub rpc_max_connections: u32,

    /// JSON-RPC server max response size limit in bytes
    #[arg(
        id = "rpc.max_response_size_bytes",
    ...
    #[arg(id = "rpc.max_subscriptions", long = "max-subscriptions", default_value = "30")]
    #[serde(rename = "max_subscriptions")]
    pub rpc_max_subscriptions: u32,

    /// Health check interval in seconds
    #[arg(id = "rpc.health_check_interval_ms", long = "health-check-interval", default_value = "100")]
    pub health_check_interval_ms: u64,

    /// JSON-RPC server max batch request limit
    #[arg(id = "rpc.batch_request_limit", long = "batch-request-limit", default_value = "500")]
    ...
    #[arg(
        id = "rpc.debug_trace_unsuccessful_only",
        long = "rpc-debug-trace-unsuccessful-only",
        value_parser = Self::parse_rpc_client_app_hashset
    )]
