...
const DEFAULT_ACCOUNT_SLOTS_CACHE: usize = 125 * GIGABYTE;
const DEFAULT_ACCOUNT_SLOTS_HISTORY_CACHE: usize = 100 * GIGABYTE;
const DEFAULT_TRANSACTIONS_CACHE: usize = 41 * GIGABYTE;
const DEFAULT_BLOCKS_BY_HASH_CACHE: usize = 2 * GIGABYTE;
const DEFAULT_BLOCKS_BY_NUMBER_CACHE: usize = 250 * GIGABYTE;
