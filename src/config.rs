...
pub struct ImporterOnlineConfig {
    ...
    #[arg(long = "sync-interval", value_parser=parse_duration, env = "SYNC_INTERVAL", default_value = "700ms")]
...
pub struct StateValidatorConfig {
    ...
    #[arg(short = 'i', long = "interval", value_parser=parse_duration, env = "INVERVAL", default_value = "1s")]
